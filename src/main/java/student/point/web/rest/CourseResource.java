...
import student.point.service.CourseQueryService;
...
/**
 * REST controller for managing {@link student.point.domain.Course}.
 */
@RestController
...
public class CourseResource {
    ...
    public ResponseEntity<CourseDTO> createCourse(@RequestBody CourseDTO courseDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/courses/" + courseDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, courseDTO.getId().toString()))
            .body(courseDTO);
    }
