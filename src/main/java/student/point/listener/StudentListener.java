...
public class StudentListener {
    ...
    public StudentListener(@Lazy IdGeneratorService idGeneratorService) {
        this.idGeneratorService = idGeneratorService;
    }

    @PrePersist
    public void generateApplicationRegisterId(Student application) {
        if (application.getStudentCode() == null) {
            application.setStudentCode(idGeneratorService.generateNextId(ListenerEnum.STUDENT.getCode()));
        }
